...
#import "PPX_WebViewProress.h"
#import "PPX_WebProgressView.h"

@interface PPX_WEWebViewController ()<UIWebViewDelegate,PPX_WebViewProgressDelegate ,WKUIDelegate,WKNavigationDelegate,WKScriptMessageHandler>
{
    BOOL _isFile;
    WKWebView *_wkWebView;
    UIWebView *_uiWebView;
    PPX_WebProgressView *_progressView;
    PPX_WebViewProress *_progressProxy;
}
...
@implementation PPX_WEWebViewController
...
- (void)initialize{
    ...
    if (self.useUIWebView) {
        ...
        if (![self isNavigationHidden]) {
            _progressProxy = [[PPX_WebViewProress alloc]init];
    ...
    _progressView = [[PPX_WebProgressView alloc]initWithFrame:CGRectMake(0, [self isNavigationHidden]?1:65, self.view.frame.size.width, 2)];
    if(_tintColor){
